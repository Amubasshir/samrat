      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="text-2xl font-serif font-bold text-gold block mb-6">
              Attorney at Law
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li><a href="#" className="hover:text-gold transition-colors">Estate Planning</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-900 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
          <p>&copy; {new Date().getFullYear()} Attorney at Law. All rights reserved.</p>
